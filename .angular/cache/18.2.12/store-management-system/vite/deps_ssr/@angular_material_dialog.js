...
var FocusTrap = class {
  ...
  _executeOnStable(fn) {
    if (this._ngZone.isStable) {
      ...
      this._ngZone.onStable.pipe((0, import_operators5.take)(1)).subscribe(fn);
    }
  }
};
...
var DialogRef = class {
  constructor(overlayRef, config) {
    ...
    this.config = config;
    this.closed = new import_rxjs7.Subject();
...
var Dialog = class _Dialog {
  ...
  constructor(_overlay, _injector, _defaultOptions, _parentDialog, _overlayContainer, scrollStrategy) {
    ...
    this._afterAllClosedAtThisLevel = new import_rxjs7.Subject();
    this._afterOpenedAtThisLevel = new import_rxjs7.Subject();
    this._ariaHiddenElements = /* @__PURE__ */ new Map();
    this.afterAllClosed = (0, import_rxjs7.defer)(() => this.openDialogs.length ? this._getAfterAllClosed() : this._getAfterAllClosed().pipe((0, import_operators6.startWith)(void 0)));
...
var MatDialogRef = class {
  constructor(_ref, config, _containerInstance) {
    ...
    this._beforeClosed = new import_rxjs9.Subject();
    this._state = 0;
    this.disableClose = config.disableClose;
    this.id = _ref.id;
    ...
    (0, import_rxjs9.merge)(this.backdropClick(), this.keydownEvents().pipe((0, import_operators8.filter)((event) => event.keyCode === ESCAPE && !this.disableClose && !hasModifierKey(event)))).subscribe((event) => {
      if (!this.disableClose) {
        event.preventDefault();
...
var MatDialog = class _MatDialog {
  ...
  constructor(_overlay, injector, location, _defaultOptions, _scrollStrategy, _parentDialog, _overlayContainer, _animationMode) {
    ...
    this._parentDialog = _parentDialog;
    this._openDialogsAtThisLevel = [];
    this._afterAllClosedAtThisLevel = new import_rxjs9.Subject();
    this._afterOpenedAtThisLevel = new import_rxjs9.Subject();
    this.dialogConfigClass = MatDialogConfig;
    this.afterAllClosed = (0, import_rxjs9.defer)(() => this.openDialogs.length ? this._getAfterAllClosed() : this._getAfterAllClosed().pipe((0, import_operators8.startWith)(void 0)));
